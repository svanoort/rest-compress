...
- Full derivation of the equation above (and math for deciding which algorithm to use) is [here](https://github.com/svanoort/rest-compress/wiki/Comparing-Speed-of-Different-Compression-Algorithms)
